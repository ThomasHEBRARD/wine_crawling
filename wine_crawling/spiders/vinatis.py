...
class VinatisSpider(scrapy.Spider):
    name = "vinatis"
    domain_name = "https://www.vinatis.com"

    start_urls = [
        "https://www.vinatis.com/achat-vin#p1&n15&t7&f[]27[]11425[]s"
    ]
    ...
    BASE_HEADER = {
        ...
        "origin": "https://www.vinatis.com",
        "User-Agent": "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.130 Safari/537.36",
        "Sec-Fetch-User": "?1",
        "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
        "Sec-Fetch-Site": "none",
        "Referer": "https://www.vinatis.com/achat-vin#p1&n15&t7&f[]27[]11425[]s",
    ...
    def parse(self, response):
        last_page = response.xpath(
            '//span[@class="pagination_center taille-md"]'
        )
        print(last_page)
